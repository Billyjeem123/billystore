            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="javascript:void(0)" id="MyAccout" class="flex-c-m p-lr-10 trans-04 <?php if (!empty($_SESSION['userid']) && $_SESSION['userid']) {
                                                                                                        echo 'login';
                                                                                                    }  ?>">
                            My Account
                        </a>
            ...
            <ul class="topbar-mobile">
                ...
                <li>
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="javascript:void(0)" id="MyAccout2" class="flex-c-m p-lr-10 trans-04 <?php if (!empty($_SESSION['userid']) && $_SESSION['userid']) {
                                                                                                            echo 'login';
                                                                                                        }  ?>">
                            My Account
                        </a>
